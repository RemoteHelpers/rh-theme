...
<!--		</tr>-->
        ...
        <div class="order-for">
            <span>for <?php echo count( WC()->cart->get_cart() ) ?> <?php if (count( WC()->cart->get_cart() ) === 1) {echo 'employee';} else {echo 'employees';}?></span>
        </div>
		<?php do_action( 'woocommerce_cart_totals_after_order_total' ); ?>
        <ul class="basket_nav">
            <li><a class="basket_nav_pdf" href="#" target="_blank">Watch draft agreement</a></li>
            <li><a href="<?php echo get_permalink(463) ?>" target="_blank">FAQ</a></li>
