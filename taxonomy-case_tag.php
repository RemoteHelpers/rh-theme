    ...
    <main id="primary" class="site-main">
		...
		<?php if ( have_posts() ) : ?>
			...
			<a class="this_tag" href="https://www.rhelpers.com/cases"><p class="cat_name">Cases</p></a>
				...
				echo '<a class="this_tag" href="'.get_term_link($custom_term).'"><p>'.$custom_term->name.'</p></a>';
				?>
				</div>
				<?php
			}
				...
				echo '<a class="this_tag" href="'.get_term_link($custom_term).'"><h1 class="page-title">Back to all '.$custom_term->name.'</h1></a>';
				}

				the_archive_description( '<div class="archive-description">', '</div>' );

				echo '<h3 class="cat_sub">'.$custom_tag->name.'</h3>'
				?>
			</header><!-- .page-header -->
