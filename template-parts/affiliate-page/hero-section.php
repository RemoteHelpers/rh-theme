<?php
/**
 * Template Hero Section of Affilifate page
 */
?>
<section class="hero">
    ...
    <div class="container">
        <div class="hero__inner">
            <div class="hero__left">
                <h1>
                    <?php the_field('affiliate_header_title'); ?>
                </h1>
                <p><?php the_field('affiliate_header_subtitle'); ?></p>
                <button>
                    <?php the_field('affiliate_button_text'); ?>
            ...
            <div class="hero__right">
                <img src="<?php the_field('affiliate_header_image'); ?>" alt="">
            </div>
        </div>
    </div>
</section>