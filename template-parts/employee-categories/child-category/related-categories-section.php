<?php
/**
 * Template Related Categories of Child Category
 */
?>
    <section id="other_cats">
        <?php
        ...
        if ( $main_term->parent != 0 && $main_term->slug != "lead-generation-manager" ) {
        ?>
            <h2 class="pricing-cards__title">You may also be interested</h2>
                <div class="sub_category_block_wrap">
                    ...
                    foreach ( get_terms( $args_query ) as $term ) {
                        if( $term->term_id != $main_term->term_id ) {
                            ...
                            $sub_category_thumbnail_id = get_term_meta($sub_cat_id, 'thumbnail_id', true);
                            $sub_thumbnail_image_url = wp_get_attachment_url($sub_category_thumbnail_id);
                            $link = get_term_link( $sub_cat_id, 'product_cat' );
                            ?>
                                    ...
                                    <div class="sub_category_block">
                                        <div class="sub_category_top">
                                            <div class="sub_category_image">
                                                <?php
                                                echo '<img class="lozad" data-src="' . $sub_thumbnail_image_url . '"/>';
                                                ?>
                                            </div>
                                        ...
                                        <div class="sub_category_description">
                                            <p class="cat-desc"><?php echo get_field('sub_hero_subtitle', 'category_'.$sub_cat_id); ?></p>
                                        </div>
                                            <span class="svg-link" href="<?php echo $link;?>"><svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
