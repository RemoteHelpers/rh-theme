...
$wc_product_tag = substr($url, strrpos($url,"/")+1);
$wc_tag_name = strtr($wc_product_tag, array ('_' => ' '));
$wc_tag_name = strtoupper($wc_tag_name);
?>
    <section class="category tag__section">
        <h1 class="employees_title" style="text-transform: capitalize ; "><?php echo  $wc_tag_name?></h1>
